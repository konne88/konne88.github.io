...
Yet, despite the importance of commutative diagrams, formalizations of category theory in proof assistants ([of which there are many][LIST]) do not support them. Until now! This projects source code can be downloaded from [GitHub][GH].
